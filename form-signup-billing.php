      ...
      <div class="large-8 columns">
        ...
        <form>
          <div class="row">
            ...
            <fieldset>
              ...
              <div class="row">
                <div class="large-12 columns">
                  <input id="checkbox1" type="checkbox"><label for="checkbox1">Auto-fill Billing address to match Contact Information</label>
                </div>
              </div>
              <!-- row -->
            ...
            <a href="form-signup-disclaimer.php" class="button right">Disclaimer ></a>
